...
greenGeorge.meta = (function () {
  ...
  const isDefined = (x) => typeof x !== "undefined",
    ...
    doComper = (f1, f2) => compose(f2, f1),
    doCompo = (f1, f2) => compose(invoke, f2, f1),
    doCompArg = (f1, f2, seed) => compose(f2(seed), f1),
    doWhenFactory = (n) => {
